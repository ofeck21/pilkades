...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Pesan Terkirim</h3> </div>
                ...
                <div class="card-body">
                    <div class="card-content">
                        ...
                        <div class="inbox-leftbar">
                            <?php if ($_GET['pesanterkirim']=='detail') { ?>

                                <a class="btn btn-danger btn-block waves-effect waves-light" href="?pesanterkirim">Pesan Terkirim</a>
                        ...
                        <div class="clearfix"></div>
                           <?php if ($_GET['pesanterkirim']=='detail') {
                           ...
                           }elseif ($_GET['pesanterkirim']=='hapus') { 
                                $id = $_GET['q'];
                            ...
                            <div class="mt-4">
                                <table class="table table-hover">
                                    ...
                                    <tbody class="kotak-terkirim"></tbody>
                                </table>
                            </div>
                            <?php } ?>
                    </div>
